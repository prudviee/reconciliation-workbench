...
- [x] **FND-T07 — Revoke on deletion and expiry before cleanup** (`FND-004`, `FND-011`; `FND-A04`, `FND-A06`)
...
- [x] **FND-T08 — Add correlation and privacy-safe structured logs** (`FND-009`; `FND-A09`)
