...
- [x] **ING-T10 — Deliver the upload, map, preview, and activate interface** (`ING-003`, `ING-004`, `ING-011`, `ING-013`, `ING-017`; `ING-A01`, `ING-A02`, `ING-A07`, `ING-A11`, `ING-A14`, `ING-A16`)
