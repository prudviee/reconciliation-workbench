...
- [ ] **ING-T08 — Apply explicit deltas against the previewed base** (`ING-006`, `ING-008`, `ING-016`; `ING-A04`, `ING-A13`, `ING-A17`)
...
- [ ] **ING-T09 — Enforce cancellation and ingestion isolation at every boundary** (`ING-012`, `ING-018`; `ING-A12`, `ING-A15`)
